<div class="row mt-2">
  <div class="col-sm-12">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Tabungan BPJS Kesehatan</li>
    </ol>
  </div><!-- /.col -->
</div><!-- /.row -->
<div class="row">
	<div class="col-sm-12">
		<div class="card">
			<div class="card-header bg-orange">
				<h5 class="card-title">BPJS Kesehatan : <?= $_SESSION['nama_user']; ?></h5>
				<div class="card-tools">
					<div class="input-group input-group-sm" style="width: 150px;">
						<a href="pages_slip/download/laporan_bpjs_kes.php" target="_blank"><button class="btn bg-dark"> <i class="fa fa-download"></i> Download</button></a>
					</div>
				</div>
			</div>
			<div class="card-body">
				<div class="table-responsive p-0" style="height: 450px;">
					<table class="table table-thead-fixed table-nowrap table-hover">
						...
						<?php }
						$bpjs = mysqli_query($koneksi, "SELECT SUM(tunjangan_kesehatan) AS bpjs_kesehatan FROM tb_tabungan_tunjangan X INNER JOIN tb_user Y ON y.id_user = x.id_user INNER JOIN tb_rols_user z ON z.id_user = x.id_user INNER JOIN tb_jabatan a ON a.id_jabatan = z.id_jabatan WHERE x.id_user = '".$_SESSION['id_user']."'");
						$sqb = mysqli_fetch_array($bpjs);
						?>
						<tr>
							<td colspan="4">Total :</td>
							<td colspan="3"><?= rupiah($sqb['bpjs_kesehatan']); ?></td>
						</tr>
						</tbody>
					</table>
				</div>
