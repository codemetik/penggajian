...
<div class="card">
	<div class="card-header bg-dark">
		<h5>Profile <?= $_SESSION['nama_jabatan']; ?></h5>
	</div>
	<div class="card-body">
		<form action="pages_slip/proses/proses_simpan_mydata.php" method="POST">
		<div class="row">
			<div class="col-sm-4">
			...
			<div class="col-sm-3">
				...
				<a href="myslip.php?page=home" class="btn bg-dark">Cencel</a>
			</div>
		</div>
		</form>	
	</div>
