		...
		<div class=card>
			...
			<form action="" method="POST">
				<div class="row">
					...
					<div class="col-sm-12">
						<button type="submit" class="btn bg-dark" name="simpan_pinjaman"><i class="fa fa-save"></i> Simpan Perubahan</button>
						<a href="?page=pinjaman_karyawan" class="btn bg-dark">Cencel</a>
					</div>
				</div>
			</form>
			</div>
